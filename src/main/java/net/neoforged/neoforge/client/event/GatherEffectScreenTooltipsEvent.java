...
/**
 * Stub: Fired to gather effect screen tooltips.
 */
public class GatherEffectScreenTooltipsEvent extends net.neoforged.bus.api.Event {
    ...
    public EffectRenderingInventoryScreen<?> getScreen() { return this.screen; }
    public MobEffectInstance getEffectInstance() { return this.effectInst; }
